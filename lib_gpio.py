...
button_2 = Button(pin=config.button_gpio_2,hold_time=2)
button_3 = Button(pin=config.button_gpio_3,hold_time=2)
button_4 = Button(pin=config.button_gpio_4)
button_5 = Button(pin=config.button_gpio_5)
button_6 = Button(pin=config.button_gpio_6)
button_7 = Button(pin=config.button_gpio_7,hold_time=1)
button_8 = Button(pin=config.button_gpio_8,hold_time=1)
